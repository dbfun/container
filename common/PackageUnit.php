<?
class PackageUnit {
  protected $containers = array(), $maxWeight = 20;
  ...
  final public function put($containerId, $weight) {
  ...
  // Вес контейнера
  final public function weight($containerId) {
  ...
  final private function totalWeight() {
